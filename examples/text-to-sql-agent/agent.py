...
def create_sql_bog_agent():
    """Create and return a text-to-SQL Bog Agents agent"""
    ...
    # Create the Bog Agents agent with all parameters
    agent = create_agent(
...
def main():
    """Main entry point for the SQL Bog Agents agent CLI"""
    parser = argparse.ArgumentParser(
        description="Text-to-SQL Bog Agents agent powered by LangChain Bog Agents and Claude Sonnet 4.5",
...
Examples:
  ...
  python agent.py "How many customers are from Canada?"
    ...
    # Create the agent
    console.print("[dim]Creating SQL Bog Agents agent...[/dim]")
    agent = create_sql_bog_agent()
