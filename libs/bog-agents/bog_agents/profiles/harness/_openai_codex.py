...
behavior-shaping `system_prompt_suffix` that aligns bog-agents' runtime
defaults with how Codex was trained to operate — autonomous senior
engineer demeanor, bias to action, parallel tool use, and TODO hygiene.
