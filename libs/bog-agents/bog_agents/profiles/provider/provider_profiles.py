...
Provider profiles declare how bog-agents should construct a chat model for a
...
class ProviderProfile:
    ...
    profile system consumed by `create_agent`, not here.

    Example:
        Set a default temperature for a hypothetical provider:

        ```python
        from bog_agents import ProviderProfile, register_provider_profile
