...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "AgentTeamsMiddleware": ("agent_teams", "AgentTeamsMiddleware"),
    ...
    "ClientKnowledgeBaseMiddleware": ("client_knowledge_base", "ClientKnowledgeBaseMiddleware"),
    "ClientReportsMiddleware": ("client_reports", "ClientReportsMiddleware"),
    ...
    "DueDiligenceMiddleware": ("due_diligence", "DueDiligenceMiddleware"),
    "EarningsAnalysisMiddleware": ("earnings_analysis", "EarningsAnalysisMiddleware"),
    ...
    "FinancialDataMiddleware": ("financial_data", "FinancialDataMiddleware"),
    "FirmDeploymentMiddleware": ("firm_deployment", "FirmDeploymentMiddleware"),
    ...
    "MarketSentimentMiddleware": ("market_sentiment", "MarketSentimentMiddleware"),
    "MeetingPrepMiddleware": ("meeting_prep", "MeetingPrepMiddleware"),
    ...
    "MultiAgentOrchestratorMiddleware": ("multi_agent_orchestrator", "MultiAgentOrchestratorMiddleware"),
    ...
    "PeerComparisonMiddleware": ("peer_comparison", "PeerComparisonMiddleware"),
    "PlanModeMiddleware": ("plan_mode", "PlanModeMiddleware"),
    "PluginSystemMiddleware": ("plugin_system", "PluginSystemMiddleware"),
    "PortfolioAnalysisMiddleware": ("portfolio_analysis", "PortfolioAnalysisMiddleware"),
    ...
    "RegulatoryAlertsMiddleware": ("regulatory_alerts", "RegulatoryAlertsMiddleware"),
    "RegulatoryImpactMiddleware": ("regulatory_impact", "RegulatoryImpactMiddleware"),
    ...
    "SSOAuthMiddleware": ("sso_auth", "SSOAuthMiddleware"),
    "SafeToolsConfig": ("safe_tools", "SafeToolsConfig"),
    "SavedPromptsMiddleware": ("saved_prompts", "SavedPromptsMiddleware"),
    "ScenarioEngineMiddleware": ("scenario_engine", "ScenarioEngineMiddleware"),
    ...
    "TaxOptimizationMiddleware": ("tax_optimization", "TaxOptimizationMiddleware"),
