...
class FilesystemMiddleware(AgentMiddleware[FilesystemState, ContextT, ResponseT]):
    ...
    def __init__(
        ...
        *,
        ...
        self.tools.append(create_multi_edit_file_tool(self.backend, self._get_backend))
        ...
        self.tools.append(create_read_many_files_tool(self.backend, self._get_backend))
