...
import bog_agents.middleware.filesystem as filesystem_middleware
from bog_agents.backends import CompositeBackend, StateBackend
from bog_agents.backends.protocol import ExecuteResponse, GlobResult, SandboxBackendProtocol
from bog_agents.middleware.filesystem import FileData, FilesystemMiddleware, FilesystemState
...
class TestFilesystemMiddlewareAsync:
    ...
    async def test_glob_timeout_returns_error_message_async(self):
        ...
        async def slow_aglob(*_args: object, **_kwargs: object) -> GlobResult:
