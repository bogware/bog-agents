...
async def analyze_failed_trial(trial: Trial, analyze_pending: bool = False) -> Optional[str]:
    """
    Run bog-agents agent analysis on a failed or pending trial trajectory.
    ...
    """
    # Create the bog-agents agent for trajectory analysis
    analysis_agent = create_agent(tools=[], system_prompt=ANALYSIS_PROMPT)
    ...
    # Run the bog-agents agent analysis
