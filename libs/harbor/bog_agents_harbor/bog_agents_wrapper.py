"""A wrapper for Bog Agents to run in Harbor environments."""
...
class BogAgentsWrapper(BaseAgent):
    """Harbor agent implementation using LangChain Bog Agents.

    Wraps Bog Agents to execute tasks in Harbor environments.
    """
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            use_cli_agent: If True, use create_cli_agent from bog-agents-cli (default).
                If False, use create_agent from SDK.
        """
    ...
    async def run(
        ...
        """Execute the Bog Agents agent on the given instruction.
        ...
        if langsmith_experiment_name:
            with trace(
                ...
                # Invoke bog-agents agent with LangSmith tracing
                result = await bog_agent.ainvoke(
