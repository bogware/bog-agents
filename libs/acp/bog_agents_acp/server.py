"""ACP server implementation for Bog Agents."""
...
from bog_agents.backends import CompositeBackend, FilesystemBackend, StateBackend
...
if TYPE_CHECKING:
    ...
    from bog_agents.graph import Checkpointer
    from langchain.tools import ToolRuntime
    from langchain_core.runnables import RunnableConfig

from bog_agents_acp.utils import (
...
class AgentServerACP(ACPAgent):
    ...
    async def _log_text(self, session_id: str, text: str) -> None:
        ...
        await self._conn.session_update(session_id=session_id, update=update, source="Bog Agents")
    ...
    async def prompt(  # noqa: C901, PLR0912, PLR0915  # Complex streaming protocol handler with many branches
        ...
        **kwargs: Any,  # noqa: ARG002  # ACP protocol interface parameter
        ...
        # Stream the bog-agents agent response with multimodal content
            ...
            async for stream_chunk in agent.astream(
                ...
                # Check for tool results (ToolMessage responses)
                    ...
                    if (
                        ...
                        await self._conn.session_update(
                            session_id=session_id, update=update, source="Bog Agents"
                        )
        ...
        if current_state.next and current_state.interrupts:
            ...
            for interrupt in current_state.interrupts:
                ...
                if isinstance(interrupt_value, dict):
                    # Bog Agents wraps tool calls in action_requests
