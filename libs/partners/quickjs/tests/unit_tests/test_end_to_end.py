...
def test_bog_agents_with_quickjs_interpreter() -> None:
...
def test_bog_agents_with_quickjs_langchain_tool_single_arg_foreign_function() -> None:
...
def test_bog_agents_with_quickjs_langchain_tool_multi_arg_foreign_function() -> None:
...
def test_bog_agents_with_quickjs_langchain_tool_list_of_ints_foreign_function() -> None:
...
def test_bog_agents_with_quickjs_langchain_tool_json_stringify_foreign_function() -> (
    None
):
...
def test_bog_agents_with_quickjs_langchain_tool_dict_foreign_function() -> None:
