...
SLASH_COMMANDS: list[tuple[str, str, str]] = [
    ...
    ("/background", "Manage background agent tasks (run/list/cancel/status)", "bg task async"),
    ...
    ("/dashboard", "Show multi-agent dashboard with status and costs", "agents monitor panel"),
