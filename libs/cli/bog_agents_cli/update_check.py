"""Background update check for bog-agents-cli.
...
PYPI_URL = "https://pypi.org/pypi/bog-agents-cli/json"
CACHE_FILE: Path = DEFAULT_CONFIG_DIR / "latest_version.json"
CACHE_TTL = 86_400  # 24 hours
USER_AGENT = f"bog-agents-cli/{__version__} update-check"
...
def get_latest_version() -> str | None:
    """Fetch the latest bog-agents-cli version from PyPI, with caching.
...
def is_update_available() -> tuple[bool, str | None]:
    """Check whether a newer version of bog-agents-cli is available.
