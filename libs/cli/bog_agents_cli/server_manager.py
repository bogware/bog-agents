...
if TYPE_CHECKING:
    ...
    from bog_agents_cli.mcp_tools import MCPSessionManager
...
def _scaffold_workspace(work_dir: Path) -> None:
    ...
    """
    from bog_agents_cli.server import generate_langgraph_json
...
async def start_server_and_get_agent(
    *,
    ...
    work_dir = Path(tempfile.mkdtemp(prefix="bog_agents_server_"))
