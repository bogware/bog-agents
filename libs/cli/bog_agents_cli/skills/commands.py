...
- bog-agents skills list [options]
- bog-agents skills create <name> [options]
- bog-agents skills info <name> [options]
- bog-agents skills delete <name> [options]
"""
...
if TYPE_CHECKING:
    ...
    from bog_agents.middleware.skills import SkillMetadata

    from bog_agents_cli.output import OutputFormat

from bog_agents_cli.config import COLORS, Settings, console, get_glyphs
...
def _list(
    ...
    if project:
        ...
        if not has_project_skills and not has_agent_skills:
            if output_format == "json":
                from bog_agents_cli.output import write_json
            ...
            console.print(
                ...
                "  bog-agents skills create my-skill --project[/dim]",
                style=COLORS["dim"],
            )
            return
        ...
        if not skills:
            ...
            console.print(
                ...
                "  bog-agents skills create my-skill[/dim]",
                style=COLORS["dim"],
            )
            return
...
def _create(
    ...
    *,
    ...
    console.print(
        ...
        f"  nano {skill_md}\n"
        "\n"
        "  See examples/skills/ in the bog-agents-cli repo for example skills:\n"
        "   - web-research: Structured research workflow\n"
        "   - langgraph-docs: LangGraph documentation lookup\n"
        "\n"
        "   Copy an example:\n"
        "   cp -r examples/skills/web-research ~/.bog-agents/agent/skills/\n",
        style=COLORS["dim"],
    )
...
def setup_skills_parser(
    ...
    *,
    ...
    `bog-agents skills -h` shows skills-specific help, not the
    global help.
    ...
    create_parser = skills_subparsers.add_parser(
        ...
        description=(
            ...
            "~/.bog-agents/<agent>/skills/. "
            "Use --project to create in the project's "
            ".bog-agents/skills/ directory."
        ),
        add_help=False,
