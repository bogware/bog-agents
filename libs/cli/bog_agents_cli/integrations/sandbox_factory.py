...
from bog_agents_cli.config import console, get_glyphs
...
if TYPE_CHECKING:
    ...
    from bog_agents_cli.integrations.sandbox_provider import SandboxProvider
...
def _get_provider(provider_name: str) -> SandboxProvider:
    ...
    if provider_name == "modal":
        from bog_agents_cli.integrations.modal import ModalProvider

        return ModalProvider()
    if provider_name == "runloop":
        from bog_agents_cli.integrations.runloop import RunloopProvider
