...
from bog_agents_cli.integrations.sandbox_provider import (
    SandboxProvider,
)
...
class ModalProvider(SandboxProvider):
    ...
    def __init__(self, app_name: str = "bog-agents-sandbox") -> None:
        """Initialize Modal provider.

        Args:
            app_name: Name for the Modal app (default: "bog-agents-sandbox")
        """
        import modal
