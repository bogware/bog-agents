...
`libs/bog-agents/tests/unit_tests/middleware/test_compact_tool.py`.
"""
...
from bog_agents_cli.tool_display import format_tool_display
...
class TestHITLGating:
    ...
    def test_hitl_gating_when_enabled(self) -> None:
        ...
        with patch("bog_agents_cli.agent.REQUIRE_COMPACT_TOOL_APPROVAL", True):
    ...
    def test_hitl_gating_when_disabled(self) -> None:
        ...
        with patch("bog_agents_cli.agent.REQUIRE_COMPACT_TOOL_APPROVAL", False):
            from bog_agents_cli.agent import _add_interrupt_on
