...
class TestThreadRelativeTimePersistence:
    ...
    def test_default_is_true(self, tmp_path: Path) -> None:
        ...
        from bog_agents_cli.model_config import load_thread_relative_time
    ...
    def test_preserves_other_config_sections(self, tmp_path: Path) -> None:
        ...
        from bog_agents_cli.model_config import save_thread_relative_time
...
class TestThreadSortOrderPersistence:
    ...
    def test_default_is_updated_at(self, tmp_path: Path) -> None:
        ...
        from bog_agents_cli.model_config import load_thread_sort_order
    ...
    def test_preserves_other_config_sections(self, tmp_path: Path) -> None:
        ...
        from bog_agents_cli.model_config import save_thread_sort_order
...
class TestThreadConfigCoalesced:
    ...
    def test_defaults_when_no_file(self, tmp_path: Path) -> None:
        ...
        from bog_agents_cli.model_config import load_thread_config
...
"""
    ...
    def test_save_invalidates_cache(self, tmp_path: Path) -> None:
        ...
        try:
            ...
            from bog_agents_cli.model_config import _thread_config_cache
...
class TestModelPersistenceBetweenSessions:
    ...
    def test_saved_model_is_used_when_no_model_specified(self, tmp_path):
        ...
        """
        from bog_agents_cli.config import _get_default_model_spec

        # Use a temporary config path
        config_path = tmp_path / ".bog-agents" / "config.toml"
...
""")
        ...
        with (
            ...
            patch.object(model_config, "DEFAULT_CONFIG_PATH", config_path),
            caplog.at_level(logging.WARNING, logger="bog_agents_cli.model_config"),
        ):
            models = get_available_models()
...
temperature = 0.5
""")
        with caplog.at_level(logging.WARNING, logger="bog_agents_cli.model_config"):
