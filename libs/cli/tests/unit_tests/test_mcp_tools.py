...
class TestDiscoverMcpConfigs:
    ...
    def test_user_level_only(
        ...
        """Only ~/.bog-agents/.mcp.json exists."""
        home = tmp_path / "home"
        user_dir = home / ".bog-agents"
    ...
    def test_project_agents_subdir_only(
        self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
        """Only <project>/.bog-agents/.mcp.json exists."""
        home = tmp_path / "home"
        home.mkdir()
        project = tmp_path / "project"
        subdir = project / ".bog-agents"
    ...
    def test_all_three_locations(
        ...
        project = tmp_path / "project"
        proj_subdir = project / ".bog-agents"
...
class TestResolveAndLoadMcpTools:
    ...
    @patch("bog_agents_cli.mcp_tools._load_tools_from_config")
    @patch("bog_agents_cli.mcp_trust.is_project_mcp_trusted")
...
class TestClassifyDiscoveredConfigs:
    ...
    def test_project_config_classified(self, tmp_path: Path) -> None:
        """Paths outside ~/.bog-agents/ are classified as project."""
