...
from bog_agents_cli.config import SHELL_ALLOW_ALL, ModelResult
...
class TestMakeHitlDecision:
    ...
    def test_shell_without_allow_list_rejected(self, console: Console) -> None:
        ...
        with patch("bog_agents_cli.non_interactive.settings") as mock_settings:
...
class TestQuietMode:
    ...
    async def test_console_creation(
        ...
        with (
            patch(
                "bog_agents_cli.non_interactive.Console",
...
class TestFastFollowLangsmithLink:
    ...
    async def test_prints_link_when_lookup_ready(self) -> None:
        ...
        with (
            ...
            patch(
                "bog_agents_cli.non_interactive._start_langsmith_thread_url_lookup",
