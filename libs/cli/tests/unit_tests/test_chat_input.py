...
from bog_agents_cli.widgets import chat_input as chat_input_module
...
class TestHistoryRecallSuppressesCompletions:
    ...
    async def test_history_recall_does_not_trigger_completions(self) -> None:
        ...
        async with app.run_test() as pilot:
            ...
            chat._history._entries.append("tell me about @qqzzkk99.zzz")

            await pilot.press("up")
            await pilot.pause()

            assert chat._text_area.text == "tell me about @qqzzkk99.zzz"
            assert chat._current_suggestions == []
