...
from bog_agents_cli.app import BogAgentsApp, _format_compact_limit
...
_CREATE_MODEL_PATH = "bog_agents_cli.app.create_model"
_COMPUTE_DEFAULTS_PATH = (
    "bog_agents.middleware.summarization.compute_summarization_defaults"
)
_LC_MIDDLEWARE_PATH = "bog_agents.middleware.summarization.SummarizationMiddleware"
