"""End-to-end unit tests for bog-agents-cli with fake LLM models."""
...
def mock_settings(
    ...
    # Patch settings
    with patch("bog_agents_cli.agent.settings") as mock_settings_obj:
        mock_settings_obj.user_agents_dir = tmp_path / "agents"
...
class TestBogAgentsCLIEndToEnd:
    """Test suite for end-to-end bog-agents-cli functionality with fake LLM."""
